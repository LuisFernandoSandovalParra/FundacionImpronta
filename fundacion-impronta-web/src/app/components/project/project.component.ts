...
export class ProjectComponent {
  ...
  projectTypeSelected = 'convocatoria';
  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      representative:
        'Laura Natalia Ostos Molina (psicóloga, especialista en psicología clínica en curso).',
      image:
        'https://static.nationalgeographic.es/files/styles/image_3200/public/coral-reefs-2728211.jpg?w=1600&h=900',
      expected_budget: 200000000,
      current_budget: 100000000,
      video: 'https://www.youtube.com/embed/urqMKaCgZZQ',
      state: 'active',
  ...
  changeProjectTypeSelected(project_type: string) {
    switch (project_type) {
      case 'convocatoria':
        this.projectTypeSelected = 'convocatoria';
